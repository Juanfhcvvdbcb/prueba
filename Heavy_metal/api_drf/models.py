...
class Domicilios(models.Model):
    id_domicilio = models.AutoField(db_column='ID_Domicilio', primary_key=True)  # Cambiado a AutoField para ser auto incremental.
    id_detallecompra = models.IntegerField(db_column='ID_DetalleCompra', blank=True, null=True)  # Cambiado a IntegerField para no ser una llave foránea.
...
class Usuarios(models.Model):
    ...
    tipo_identificacion = models.ForeignKey(TipoIdentificacion, models.DO_NOTHING, db_column='Tipo_Identificacion', blank=True, null=True)  # Field name made lowercase.
    imagen = models.CharField(db_column='Imagen', max_length=255, blank=True, null=True)  # Field name made lowercase.
    autentica_correo = models.BooleanField(default=False)
    autentica_telefono = models.BooleanField(default=False)
